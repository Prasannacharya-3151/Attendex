      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <Button
            variant="ghost"
            onClick={() => navigate("/")}
            className="w-fit p-3 rounded-full hover:bg-sky-100"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.usn}
                onChange={(e) =>
                  setFromData({ ...formData, usn: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFromData({ ...formData, branch: value })
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={formData.year}
                onValueChange={(value) =>
                  setFromData({ ...formData, year: value })
                }
              >
                <SelectTrigger>
